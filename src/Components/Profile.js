            ...
            <div className="pContainer">
              ...
              <div className="pContentRight">
                ...
                <div className="containerRight">
                  ...
                  <div >  
                  <img src={PUBLIC_ASSETS_PATH+"/map.png"} alt="" className="mapImage" />
                  </div>
                  <div>
                  <div className="lat-lang-map">
                    <div><span className="labelRights">Lat : </span>{user.address.geo.lat}</div>
                    <div><span className="labelRights">Long :  </span>{user.address.geo.lng}</div>
                  </div>
                  </div>
